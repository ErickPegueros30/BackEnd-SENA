    ...
    <tr>
      <td style="padding:35px 40px 30px;background:#ffffff;">
        ...
        <div style="background:#f8faf6;border-left:4px solid #5d8a2f;border-radius:8px;padding:18px 20px;margin-top:20px;font-size:15px;line-height:1.6;color:#1c2b14;">
          ...
          <ul style="margin-top:8px;padding-left:20px;list-style-type:disc;color:#1c2b14;">
            ${ensayosHtmlRows}
          </ul>
        </div>
...
`;
    ...
    const to = process.env.MAIL_TO_E_BILATERAL || process.env.MAIL_TO_CONTACTO || process.env.MAIL_FROM || process.env.SMTP_USER
